...
//            sb.append("&client_id=af43c655326aaa2ca97588ce636e1e29"); // TODO REST_API_KEY 입력
            ...
            sb.append("&redirect_uri=https://dearmysanta.site/oauth/kakao"); // TODO 인가코드 받은 redirect_uri 입력     
            sb.append("&code=" + code);
...
//           }
        ...
        // 디폴트 비밀번호 설정 (예: "default_password")
...
//           userService.addUser(user);
    ...
    private String convertBirthDate(String birthyear, String birthday) {
        ...
        try {
            ...
            return date.toString(); // 유효한 날짜면 반환
        } catch (DateTimeParseException e) {
            // 유효하지 않은 날짜면 기본 값 반환 (예: "0000-00-00")
            return "0000-00-00";
        }
    }
